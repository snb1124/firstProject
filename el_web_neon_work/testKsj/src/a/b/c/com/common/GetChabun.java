...
public abstract class GetChabun {
	...
	public static final String BIZ_GUBUN_NB = "NB"; // 공지사항 : NOTICE BOARD
	...
	//게시판 글 번호 2
	public static String getBoardChabun2(String type) {
		
		return BIZ_GUBUN_BD.concat(numPad(type, GetBoardMaxNum.getMaxNum2()));
	}
	...
	public static String getNoticeChabun(String type) {
		...
		return BIZ_GUBUN_NB.concat(numPad(type, GetNoticeMaxNum.getMaxNum()));
	}
