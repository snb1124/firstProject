...
public class fileUploadServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		//저장할 경로
		String saveDirectory = "C:\\00.KOSMO93\\30.Web\\el_web_neon_work\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\testKsj\\fileupload";
		...
		try {
			...
			if (aList !=null && aList.size() > 0){
				...
				out.println("<script>");				
				out.println("location.href='/testKsj/cgiTest/fileUpload.html'");
				out.println("</script>");
			}
