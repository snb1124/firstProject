...
//					alert("idCheck data >>> : " + idCheckData);
					if("ID_YES" == idCheckData){
						...
						$("#mid").css("background-color", "#F2F2F2");
						$("#mpw").focus();
					}
...
//					alert("myval >>> : " + myval);
				...
				//생년월일
				$("#mbirth").append("<option value=''>년--- </option>");
				var date = new Date();
				var year = date.getFullYear();
		        for(var i = 1901; i <= year; i++){
		            $("#mbirth").append("<option value='"+ i +"'>"+ i + "</option>");
		        }
				//월
	...
	<jsp:include page="/include/header.jsp" flush="true"></jsp:include>
		...
		<form name="memForm" id="memForm">
			<input type="hidden" name="mnum" id="mnum" readonly>		
			<table style="width:50%;">	
				<tr>
					<td colspan="2" align="center">
						<font size="4" color="black">회원가입</font>					
					</td>
				</tr>				
				<tr>
					<th>이름</th>
				...
				<tr>
					<th>비밀번호</th>
					<td style="line-height:36px;"><input type="password" name="mpw" id="mpw"><br>
				...
				<tr>
					<th>생년월일</th>
					<td>					
					<select name="mbirth" id="mbirth"></select>
				...
				<tr>
					...
					<td style="line-height:36px;">
						<input type="text" name="mzonecode" id="mzonecode" placeholder="우편번호" style="width:63px;" maxlength="6" readonly/>
				...
				<tr style="border-bottom:none;">
					<td colspan="2" align="center">
						<button type="button" id="btn" style="cursor:pointer;">가입하기</button>
						<button type="reset" style="cursor:pointer;">다시</button>
					</td>
				</tr>
			</table>
		</form>
