package com.catchdog.adoption.vo;
...
public class AdoptionVO {
	...
	public AdoptionVO(String adno, String aupkind, String akind, String aneut, String aage, String aimage,
			String agender, String ainsertdate, String acaresite, String acaretel, String aspecial, String acolor,
			String mnum, String anum, String afur, String aname, String asize, String asubject, String aupdatedate,
			String adeleteyn, String apw, int pageSize, int curPage, int groupSize, int totalCount) {
		super();
		this.adno = adno;
