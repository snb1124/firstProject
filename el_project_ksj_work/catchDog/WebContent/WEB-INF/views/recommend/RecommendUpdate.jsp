...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#btn").click(function(){
			...
			$("#recommendUpdate").attr({
				"action":"recommendUpdate.cd",
				"method":"POST"
			}).submit();
		});
	...
	function compCheck(){
		...
		// 개 크기
		$("input:radio[name='asize']:radio[value='<%= asize %>']").prop('checked', true);
		selAsize('<%= asize %>');
		// 털 길이
		$("input:radio[name='afur']:radio[value='<%= afur %>']").prop('checked', true);
		selAfur('<%= afur %>'); // 고양이 세부종 펼치기
		
		$("input:radio[name='akind']:radio[value='<%= akind %>']").prop('checked', true); // 고양이 / 개 세부종 선택

		// 성별
		$("input:radio[name='agender']:radio[value='<%= agender %>']").prop('checked', true); // 선택하기			
...
<jsp:include page="/include/header.jsp" flush="true"></jsp:include>
	...
	<form name="recommendUpdate" id="recommendUpdate">

		<input type="hidden" name="mnum" id="mnum" value="<%=rvo.getMnum() %>" />
		...
		<!-- <div style="margin: auto;">
			...
			<select name="acolor" id="acolor">
				<option value="흰">흰</option>
				<option value="검">검</option>
				<option value="갈">갈</option>
				<option value="노">갈</option>
