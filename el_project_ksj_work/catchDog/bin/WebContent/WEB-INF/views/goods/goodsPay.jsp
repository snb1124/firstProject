...
$(document).ready(function(){
	...
	$(document).on("click", "#kakaoPayButton", function(){
		location.href="kakaoPayButton.cd";
});
});//ready
</script>			
</head>					
...
<table border ="1">
	<tr>
		...
		<th><input type="button" id="kakaoPayButton" value="카카오페이 결제하기"></th>	
</table>
 </form>
</body>		
</html>		