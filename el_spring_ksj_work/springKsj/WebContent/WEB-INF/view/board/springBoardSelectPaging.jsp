		...
		*/
		...
		$(document).on("click", "#knum", function(){
			...
			if($(this).prop('checked')){			 
				//$('input[type="checkbox"][name="knum"]').prop('checked',false);
		...
		$(document).on("click", "#searchBtn", function(){
			...
			$("#boardList").attr({ "method":"GET"
				                  ,"action":"boardSelectAll.jin"}).submit();
		});
		...
		$(document).on("click", "#I", function(){
			//alert("I >>> : ");
			location.href="springBoardForm.jin";
		});
		//  U
...
<tr>
	...
	<td class="tt"><img src="/springHbe/fileupload/board/sm_<%= bvo.getKfile() %>"> </td>	
</tr>	
<%
}//end of for
%>						
...
<jsp:include page="boardPaging.jsp" flush="true">
	<jsp:param name="url" value="boardSelectPaging.jin"/>
